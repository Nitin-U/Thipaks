...
<div class="container-sm margin-end">
    ...
    <div class="col d-flex justify-content-center">
        <div class="w-75 text-center ">
            <p>Thipaks LLC offers comprehensive application support services, which include assistance,
                troubleshooting, and maintenance for software applications utilized by businesses. Our goal is
                to ensure that applications run smoothly, remain up-to-date, and effectively meet the
    ...
    <div class="container">
        <p>An overview of common application support tasks:</p>
        <a href="contact.php?subject=Application%20Support"
        ...
        <div class="col-md-6">
            <ol>
                ...
                <ul class="p-0 m-0">
                    ...
                    <li>Supporting system integrations with other tools and platforms</li>
                </ul>
            </ol>
        </div>
        ...
        <div class="col-md-6">
            <ol start="6">
                ...
                <ul class="p-0 m-0">
                    ...
                    <li>Updating technical and user manuals as changes or updates are made</li>
                </ul>
            </ol>
        </div>
        <div class="col">
