...
<div class="container-sm margin-end">
    ...
    <div class="col d-flex justify-content-center">
        <div class="w-75 text-center ">
            <p>Thipaks LLC specializes in custom application design and development, creating tailored
                software solutions that meet the unique needs of businesses across various industries. Our
                team of experienced developers and designers works closely with clients to understand their
                specific requirements, workflows, and challenges.
            </p>
        </div>
    </div>
    ...
    <div class="container">
        <p>Key Services:</p>
        <a href="contact.php?subject=Custom%20Application%20Design%20and%20Development"
            ...
            <div class="col-md-6">
                <ol>
                    ...
                    <ul class="p-0 m-0">
                        ...
                        <li>Integrating with existing systems and third-party services as needed</li>
                    </ul>
                </ol>
            </div>
            ...
            <div class="col-md-6">
                <ol start="4">
                    ...
                    <ul class="p-0 m-0">
                        ...
                        <li>Monitoring performance and implementing improvements as needed</li>
                    </ul>
                </ol>
            </div>
            <a href="contact.php?subject=Custom%20Application%20Design%20and%20Development"
