                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne1">
                            <button class="accordion-button colored-header" type="button" data-bs-toggle="collapse"
                                ...
                                <a href="application_support.php" class="without-link"><h4>Application Support</h4></a>
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne2">
                            <button class="accordion-button colored-header" type="button" data-bs-toggle="collapse"
                                ...
                                <a href="batch_job.php" class="without-link"><h4>Batch/Jobs monitoring and support</h4></a>
                            </button>
                        </h2>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <ul style="list-style-type:circle;">
                                            ...
                                            <li>Monitoring Job Execution</li>
                                            <li>Error Detection and Resolution</li>
                                            <li>Performance Tuning</li>
                                    ...
                                    <div class="col">
                                        <ul style = "list-style-type:circle;">
                                            <li>Job Documentation and Reporting</li>
                                            <li>Data Integrity Checks</li>
                                            <li>Backup and Recovery</li>
                                            <li>Capacity Planning</li>
                                            <li>Automation and Optimization</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne3">
                            <button class="accordion-button colored-header" type="button" data-bs-toggle="collapse"
                                ...
                                <a href="custom_app.php" class="without-link"><h4>Custom Application Design and Development</h4></a>
                            </button>
                        </h2>
                ...
                <div class="accordion" id="accordionExample2">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne2">
                            <button class="accordion-button colored-header" type="button" data-bs-toggle="collapse"
                                data-bs-target="#collapseOne2" aria-expanded="true" aria-controls="collapseOne2">
                                <a href="prod_support.php" class="without-link"><h4><h4>Production Support</h4></h4></a>
                            </button>
                        </h2>
                        <div id="collapseOne2" class="accordion-collapse collapse show" aria-labelledby="headingOne2"
                            data-bs-parent="#accordionExample2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <ul style = "list-style-type:circle;">
                                            ...
                                            <li>Security Management</li>
                                            <li>Vendor and Third-Party Coordination</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
